import{m as i}from"./style-71523510.js";import{R as l}from"./regl-a5845c54.js";const o=l();let t=Math.random()*100,s=Math.random()*2e-4,n=Math.random()-.5,e=!1;const a=1e4,m=4,c=o.buffer(Array(a).fill(0).map((d,r)=>[r/a])),f=o({vert:`
