import"./style-e83eefe1.js";import{R as c}from"./regl-a5845c54.js";const e=c();let i=[0,0],t=Math.random()*50,r=Math.random()*6e-4,l=Math.random()-.5,n=!1;window.addEventListener("mousemove",o=>{i[0]=2*o.clientX/window.innerWidth-1,i[1]=1-2*o.clientY/window.innerHeight});window.addEventListener("mousedown",o=>{n=!0});const a=1e4,m=Array(a).fill(0).map((o,f)=>[f/a]),d=4*m[0].length,u=e.buffer(m),p=Array(window.innerWidth*window.innerHeight*4).fill(0),s=e.framebuffer({color:e.texture({shape:[window.innerWidth,window.innerHeight],data:p}),depthStencil:!1}),v=e({vert:`
